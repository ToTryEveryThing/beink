package com.example.common.config.operationLog;


import com.alibaba.fastjson.JSONObject;
import com.example.common.mapper.LogMapper;
...
public class MyLogAspect {
    ...
    @Pointcut("@annotation(com.example.common.config.operationLog.MyLog)")
